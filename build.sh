...
# Cambiamos systemd por sysvinit-core y fastfetch por neofetch
sudo debootstrap --no-check-gpg --variant=minbase --include=linux-image-amd64,sysvinit-core,lxde-core,lightdm,network-manager,sudo,neofetch,locales,tzdata,console-setup daedalus ./chroot http://deb.devuan.org/merged /usr/share/debootstrap/scripts/sid
